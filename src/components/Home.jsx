  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-white shadow-md p-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">Thrift Store</h1>
      </nav>
      
      {/* Hero Section */}
      <div 
        className="h-screen bg-cover bg-center flex flex-col items-center justify-center animated-bg"
        style={{ backgroundImage: "url('https://i.pinimg.com/736x/83/7a/e8/837ae84549733543a095459f9186dcff.jpg')" }}>
